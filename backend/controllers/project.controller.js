...
const create = async (req, res) => {
  try {
    const { name, code, description, status, start_date, end_date, budget, created_by_id, responsible_user_id } = req.body;
    ...
    const result = await projectService.create({ name, code, description, status, start_date, end_date, budget, created_by_id, responsible_user_id });
...
const update = async (req, res) => {
  ...
  try {
    const result = await projectService.update(id, { name, code, description, status, start_date, end_date, budget, created_by_id, responsible_user_id });
